...
public class CertUtils {
    ...
    public static X509Certificate generateX509Certificate(KeyPair pair, String dn, int days, String algorithm)
        ...
        ContentSigner contentSignerBuilder = new JcaContentSignerBuilder(algorithm)
        ...
        X509CertificateHolder holder = new X509v3CertificateBuilder(
                ...
                expires,
                name,
                SubjectPublicKeyInfo.getInstance(subPubKey.getEncoded())).build(contentSignerBuilder);
    ...
    public static X509Certificate createSignedCertificate(
        ...
        JcaX509CertificateConverter converter = new JcaX509CertificateConverter();
        JcaContentSignerBuilder contentSignerBuilder = new JcaContentSignerBuilder(issuerSigAlg)
                .setProvider(BouncyCastleProvider.PROVIDER_NAME);
    ...
    public static CertificateAndKeys createSignedCertificateAndKey(
            String dn,
            X509Certificate issuerCertificate,
            PrivateKey issuerPrivateKey,
            boolean isIntermediate)
