...
import static org.jboss.pnc.proxy.util.ProxyUtils.normalizePathAnd;

import jakarta.enterprise.context.ApplicationScoped;
import jakarta.inject.Inject;

import org.jboss.pnc.proxy.client.Classifier;
import org.jboss.pnc.proxy.util.OtelAdapter;
import org.jboss.pnc.proxy.util.UrlUtils;
...
public class ContentRetrievalService {
    ...
    public Uni<okhttp3.Response> doGet(String trackingId, String type, String name, String path) throws Exception {
        ...
        return normalizePathAnd(
                path1,
                p -> classifier.classifyAnd(
                        p,
                        HttpMethod.GET,
