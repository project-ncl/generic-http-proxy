...
import static org.jboss.pnc.proxy.util.HttpProxyConstants.PROXY_REPO_PREFIX;
...
public abstract class AbstractProxyRepositoryCreator
    ...
    @Override
    public abstract ProxyCreationResult create(
            String trackingID,
            String name,
            String baseUrl,
            UrlInfo urlInfo,
    ...
    protected RemoteRepository createRemote(
            String trackingID,
            String name,
            String baseUrl,
            UrlInfo info,
